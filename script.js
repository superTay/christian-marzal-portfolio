...
(function () {
  ...
  const i18n = {
    es: {
      ...
      'proj.landing.desc': 'Sitio de marketing público de KonquerAI en konquerai.com. Astro + Tailwind v4 con cero JS de runtime por defecto (~25 líneas vanilla), animaciones CSS-only y SEO completo (JSON-LD, sitemap, OG).',
    ...
    en: {
      ...
      'proj.landing.desc': 'KonquerAI\'s public marketing site at konquerai.com. Astro + Tailwind v4 with zero runtime JS by default (~25 lines of vanilla JS), CSS-only motion, and full SEO (JSON-LD, sitemap, OG).',
    ...
    fr: {
      ...
      'proj.landing.desc': 'Site marketing public de KonquerAI sur konquerai.com. Astro + Tailwind v4 sans JS de runtime par défaut (~25 lignes vanilla), animations CSS uniquement et SEO complet (JSON-LD, sitemap, OG).',
  ...
  const terminalContent = {
    es: [
      ...
      { type: 'out-sec', text: '🇪🇸 Español (nativo)  🇬🇧 English (Londres)  🇫🇷 Français (Paris, Marriott)' },
    ...
    en: [
      ...
      { type: 'cmd', text: 'cat languages.txt' },
      { type: 'out-sec', text: '🇪🇸 Spanish (native)  🇬🇧 English (London)  🇫🇷 French (Paris, Marriott)' },
      { type: 'cmd', text: 'ls projects/ | head -3' },
      { type: 'out', text: '→ KonquerAI    SaaS · React 19 + TS + Supabase + n8n' },
    ...
    fr: [
      ...
      { type: 'cmd', text: 'cat languages.txt' },
      { type: 'out-sec', text: '🇪🇸 Espagnol (natif)  🇬🇧 Anglais (Londres)  🇫🇷 Français (Paris, Marriott)' },
      { type: 'cmd', text: 'ls projects/ | head -3' },
      { type: 'out', text: '→ KonquerAI    SaaS · React 19 + TS + Supabase + n8n' },
