...
(function () {
  ...
  const i18n = {
    es: {
      ...
      'featured.subtitle': 'Un SaaS de facturación completo (web + móvil + backend con IA) para autónomos españoles. Construido yo solo: 327 commits, +200 horas, en producción con usuarios reales.',
    ...
    en: {
      ...
      'featured.subtitle': 'A complete invoicing SaaS (web + mobile + AI backend) for Spanish freelancers. Built entirely by me: 327 commits, 200+ hours, in production with real users.',
    ...
    fr: {
      ...
      'featured.subtitle': 'Un SaaS de facturation complet (web + mobile + backend IA) pour les indépendants espagnols. Construit seul : 327 commits, +200 heures, en production avec de vrais utilisateurs.',
